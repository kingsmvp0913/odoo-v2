...
//   userVariant  同一步對一般使用者改指可見元素、換文案；管理員仍用原步驟。
window.TOUR_COURSES = [
  {
    id: 'intro',
    name: '認識新介面',
...

  {
    ...
    steps: [
      ...
      {
        // 2026-09-23 裁決：保留四關不用等的教學；一般使用者指向看得到的動作區，
        // 不點只有平台管理員可見的「執行歷程」。管理員原步驟不變。
        route: '/task/demo',
        ...
        userVariant: {
          click: null,
          target: '[data-tour="td-action"]',
          text: '開發、QA、部署到測試環境、跑自動測試，四關都不用你出手。這段時間可以先去忙別的，動作區也換回一般留言框；真的需要你決定時，任務會停下來提醒你。'
        }
      },
      {
        route: '/task/demo',
