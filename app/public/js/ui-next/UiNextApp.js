(function () {
  ...
  window.UiNextApp = Vue.defineComponent({
    ...
    methods: {
      ...
      // ⚠ 選單必須 teleport 到 body（見 template）。.ui-next-chat-row 帶著 translate:0 -2px，
