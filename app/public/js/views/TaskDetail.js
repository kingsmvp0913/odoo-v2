const ANSWER_ALLOWED = ['confirm_pending', 'reject_confirm_pending', 'clarify_pending'];
...
window.TaskDetailView = Vue.defineComponent({
  ...
  computed: {
    ...
    timelineActionMode() {
      ...
      if (s === 'confirm_pending' || s === 'reject_confirm_pending' || s === 'clarify_pending')  return 'answer';
